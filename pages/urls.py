...
from .views import HomePageView, AboutPageView, ContactPageView, ImageViewFactory, ImageViewNoDI, ProductCreateView, ProductCreatedView, ProductIndexView, ProductShowView, CartView, CartRemoveAllView
